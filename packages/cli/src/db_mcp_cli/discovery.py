...
def _run_discovery_with_progress(
    ...
    """
    from db_mcp_knowledge.onboarding.schema_store import create_initial_schema
    ...
    if save:
        from db_mcp_knowledge.onboarding.schema_store import save_schema_descriptions
