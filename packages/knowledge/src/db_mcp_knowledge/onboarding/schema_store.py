...
def load_schema_descriptions(
    provider_id: str, *, connection_path: Path
    ...
    """
    schema_file = get_schema_file_path(connection_path)
...
def save_schema_descriptions(
    schema: SchemaDescriptions, connection_path: Path
) -> dict:
    ...
    try:
        ...
        schema_dir = connection_path / "schema"
