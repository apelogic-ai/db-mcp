...
from db_mcp_knowledge.collab.sync import (
    SyncResult,
    _branch_name,
    collaborator_pull,
    collaborator_push,
...
class TestCollaboratorPull:
    @patch("db_mcp_knowledge.collab.sync.git")
...
class TestCollaboratorPush:
    ...
    @patch("db_mcp_knowledge.collab.sync.open_pr", return_value="https://github.com/org/repo/pull/1")
...
class TestCollaboratorPushConflictFallback:
    ...
    @patch("db_mcp_knowledge.collab.sync.gh_available", return_value=True)
    @patch("db_mcp_knowledge.collab.sync.open_pr", return_value="https://github.com/org/repo/pull/99")
    @patch("db_mcp_knowledge.collab.sync.git")
...
class TestFullSync:
    @patch("db_mcp_knowledge.collab.sync.collaborator_push")
    @patch("db_mcp_knowledge.collab.sync.collaborator_pull")
    ...
    @patch("db_mcp_knowledge.collab.sync.collaborator_push")
    @patch(
        "db_mcp_knowledge.collab.sync.collaborator_pull",
