...
from db_mcp_knowledge.collab.manifest import CollabManifest, add_member, save_manifest
from db_mcp_knowledge.collab.merge import master_merge_all
from db_mcp_knowledge.collab.sync import collaborator_pull, collaborator_push, full_sync
from db_mcp_knowledge.git_utils import NativeGitBackend
...
class TestCollaboratorPushSharedStateE2E:
    @patch("db_mcp_knowledge.collab.sync.gh_available", return_value=False)
    ...
    @patch("db_mcp_knowledge.collab.sync.open_pr", return_value="https://fake/pr/1")
    @patch("db_mcp_knowledge.collab.sync.gh_available", return_value=True)
