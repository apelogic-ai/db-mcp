...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "db_mcp_cli",
        "db_mcp_cli.main",
        "db_mcp_cli.connection",
        "db_mcp_cli.git_ops",
        "db_mcp_cli.agent_config",
        "db_mcp_cli.discovery",
        "db_mcp_cli.init_flow",
        "db_mcp_cli.utils",
        "db_mcp_cli.commands",
        "db_mcp_cli.commands.core",
        "db_mcp_cli.commands.collab",
        "db_mcp_cli.commands.traces",
        "db_mcp_cli.commands.git_cmds",
