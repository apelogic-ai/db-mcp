...
from dbmcp.db.connection import get_engine
from dbmcp.onboarding.schema_store import load_schema_descriptions
from dbmcp.tasks.store import QueryStatus, get_query_store
from dbmcp.tools.shell import inject_protocol
from dbmcp.training.store import load_examples, load_instructions
from dbmcp.validation.explain import (
    CostTier,
    ExplainResult,
    explain_sql,
    validate_read_only,
...
async def _validate_sql(sql: str) -> dict:
    ...
    """
    from dbmcp.tasks.store import get_query_store
