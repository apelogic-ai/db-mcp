...
async def _get_data(
    ...
    """
    from db_mcp.tools.utils import resolve_connection, _resolve_connection_path
...
"""
    ...
    explain_result: ExplainResult = explain_sql(generated_sql, connection_path=_resolve_connection_path(connection))
