    ...
    *,
    ...
    if scenario == RUNTIME_DAEMON_SCENARIO:
        return base + (
            ...
            "Use the returned context packet, especially the decision hints, disambiguation, "
            "examples, rules, and relevant semantic guidance, to write the SQL yourself.\n"
            ...
            "error, tables to avoid, or filters that must be applied. Refinement calls may "
            "return fuller raw context and schema detail.\n"
            "Do not rely on any built-in tools.\n"
