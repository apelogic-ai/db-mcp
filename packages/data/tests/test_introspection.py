...
from db_mcp_data.db.introspection import get_tables
...
class TestGetTables:
    ...
    def test_trino_with_catalog_and_schema(self, mock_trino_engine):
        ...
        with patch("db_mcp_data.db.introspection.get_engine", return_value=mock_trino_engine):
    ...
    def test_trino_dialect_case_insensitive(self):
        ...
        with patch("db_mcp_data.db.introspection.get_engine", return_value=engine):
            mock_conn = MagicMock()
            mock_result = MagicMock()
    ...
    def test_postgresql_uses_inspector(self, mock_postgres_engine):
        ...
        with (
            patch("db_mcp_data.db.introspection.get_engine", return_value=mock_postgres_engine),
            patch("db_mcp_data.db.introspection.inspect") as mock_inspect,
        ):
